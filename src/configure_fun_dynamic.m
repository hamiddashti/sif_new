function v = configure_fun_dynamic(data)

%% Assign options

alpha_opt = 'NaN'; % Default is fixed absorption cross-sections
dynamic_solver = 'NaN';
c_steps = 'NaN';
gtc = 'NaN';
...
Ca = data.Ca./1e6;           % Atmosphere CO2
Ca_u = 'bar';
Ca_d = 'Partial pressure of CO2';
E = data.E;
