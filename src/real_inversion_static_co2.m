...
for k = 1:1:4
    for i = 1:length(leaf_ids)
        ...
        if k == 1
            ...
            weights.wPhiN =0;
            weights.wPhiDF = 0;
            [est_co2_an(:,i),fval_cmaes_an(:,i)] = cmaes('chi2_static_real_co2',vars_0,[],...
        ...
        elseif k ==2
            ...
            weights.wPhiN =0;
            weights.wPhiDF = 0;
            [est_co2_an_phip(:,i),fval_cmaes_an_phip(:,i)] = cmaes('chi2_static_real_co2',vars_0,[],...
                opts,obs,weights,v_inv)
        ...
        elseif k ==3
            ...
            weights.wPhiN =1;
            weights.wPhiDF = 0;
            [est_co2_an_phip_phin(:,i),fval_cmaes_an_phip_phin(:,i)] = cmaes('chi2_static_real_co2',vars_0,[],...
                opts,obs,weights,v_inv)
        ...
        elseif k==4
            ...
            weights.wPhiN =1;
            weights.wPhiDF = 1;
            [est_co2_an_phip_phidf_phidf(:,i),fval_cmaes_an_phip_phin_phidf(:,i)] = cmaes('chi2_static_real_co2',vars_0,[],...
                opts,obs,weights,v_inv)
...
save('est_co2_an.mat','est_co2_an')
save('est_co2_an_phip.mat','est_co2_an_phip')
save('est_co2_an_phip_phin.mat','est_co2_an_phip_phin')
save('est_co2_an_phip_phidf_phidf.mat','est_co2_an_phip_phidf_phidf')
