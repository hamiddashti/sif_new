...
v_inv.Abs =observed_static_co2.v_obs.Abs;           % Total leaf absorptance to PAR, mol mol-1
v_inv.beta = observed_static_co2.v_obs.beta;          % PSII fraction of total absorptance, mol mol-1
v_inv.Ku2 = observed_static_co2.v_obs.Ku2;           % Rate constant for exciton sharing at PSII, s-1
v_inv.CB6F = observed_static_co2.v_obs.CB6F;      % Cyt b6f density, mol sites m-2
v_inv.RUB = observed_static_co2.v_obs.RUB;      % Rubisco density, mol sites m-2
v_inv.ss = solve_c3();
% v_inv.rm = 8;
% v_inv.e1e2 = 2;
...
true_pars = [observed_static_co2.v_obs.e1e2,observed_static_co2.v_obs.Vqmax,...
    observed_static_co2.v_obs.Vcmax, observed_static_co2.v_obs.rm]'
...
[est_cmaes,fval_cmaes] = cmaes('chi2_static',vars_0,[],...
    opts,observed_static_co2,weights,v_inv)
