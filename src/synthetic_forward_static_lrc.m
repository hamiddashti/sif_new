...
data.Ci = repmat(270,n,1);                 % Atmospheric CO2, ubar
...
%%
% Run simulation
observed_static_lrc = model_fun_static(v_obs);

%%
figure(2)
subplot(5,1,1)
plot(data.Q,observed_static_lrc.An_a*1e6,'*-b')
ylabel('An_a',FontSize=13,FontWeight='bold')
xlabel('PAR',FontSize=13,FontWeight='bold')
subplot(5,1,2)
plot(data.Q,observed_static_lrc.PAM1_a,'*-b')
ylabel('PhiP',FontSize=13,FontWeight='bold')
xlabel('PAR',FontSize=13,FontWeight='bold')
subplot(5,1,3)
plot(data.Q,observed_static_lrc.PAM2_a,'*-b')
ylabel('PhiN',FontSize=13,FontWeight='bold')
xlabel('PAR',FontSize=13,FontWeight='bold')
subplot(5,1,4)
plot(data.Q,observed_static_lrc.PAM3_a,'*-b')
ylabel('PhiD+PhiF',FontSize=13,FontWeight='bold')
xlabel('PAR',FontSize=13,FontWeight='bold')

subplot(5,1,5)
plot(data.Q,observed_static_lrc.a2./v_obs.Abs.*100,'*-b')
ylabel('a2',FontSize=13,FontWeight='bold')
xlabel('PAR',FontSize=13,FontWeight='bold')
hold on 
plot(data.Q,observed_static_lrc.a1./v_obs.Abs.*100,'*-r')
...
% a1 =  observed_syn.a1;
% C = observed_syn.C;
observed_static_lrc.v_obs = v_obs;
save(strcat(outdir,"observed_static_lrc.mat"),"observed_static_lrc")
