...
% Solutions after counting for mesophyll conductance
Ag_j = ss.c3_solve_j(Ci,Kd,Kf,Kp1,O,Q,S,Vqmax,a1,nc,nl,rm);
JP700_j = ss.JP700_j_solve(Kd,Kf,Kp1,Q,Vqmax,a1);
JP680_j = ss.JP680_j_solve(Ag_j,Ci,Kd,Kf,Kp1,O,Q,S,Vqmax,a1,nc,nl,rm);
...
Ag_c = ss.c3_solve_c(Ci,Kc,Ko,O,S,Vcmax,rm);
JP680_c = ss.JP680_c_solve(Ag_c,Ci,Kc,Ko,O,S,Vcmax,rm);
JP700_c = ss.JP700_c_solve(Ag_c,Ci,Kc,Ko,O,S,Vcmax,nc,nl,rm);
...
[JP700_a,which_JP700_a] = min([JP700_j,JP700_c],[],2);
JP680_a = JP680_j.*logical(which_JP700_a == 1) + ...
    JP680_c.*logical(which_JP700_a == 2);

Ag_a = Ag_j.*logical(which_JP700_a == 1) + ...
    Ag_c.*logical(which_JP700_a == 2);
An_a = Ag_a - Rd;
